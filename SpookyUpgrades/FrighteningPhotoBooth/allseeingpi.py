...
# Tell the next filter button what to do
def next_filter():
    global filter
    filter = next(all_filters)
    preview_filter(camera, filter)
...
next_filter_btn = Button(24)
next_filter_btn.when_pressed = next_filter
